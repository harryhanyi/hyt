...
import nsrigSelfIntersectorUtils as utils

reload(utils)

HELP_DOC_URL = 'https://km.mihoyo.com/articleBase/767/268250'
...
class Command(cmdbase.Command):
        ...
        self.optionVarDefaults.update(
            {
                ...
                'intersectionPartitioning': utils.DEFAULT_SETTINGS[
                    'intersectionPartitioning'
                ],
                'partitioningThreshold': utils.DEFAULT_SETTINGS[
    ...
    def addOptionDialogWidgets(self):
        ...
        with ui_utils.AttributeLayoutManager():
            ...
            widget = ui_utils.checkBoxGrp('Intersection partitioning')
            widgetDict['intersectionPartitioning'] = (maya.cmds.checkBoxGrp, widget)
            ...
            widget = ui_utils.floatSliderGrp(
                ...
                True,
                True,
                value=utils.DEFAULT_SETTINGS['partitioningThreshold'],
            )
            widgetDict['partitioningThreshold'] = (maya.cmds.floatSliderGrp, widget)
