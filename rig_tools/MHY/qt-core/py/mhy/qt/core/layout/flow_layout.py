"""
Override Layout to dynamically rearrange widgets in a grid layout to
make the best of use of space with widget size changes
"""
...
class FlowLayout(QtWidgets.QLayout):
    ...
    def do_layout(self, rect, testonly):
        ...
        for item in self._items:
            ...
            if nextX - hspace > effective.right() and line_height > 0:
                x = effective.x()
